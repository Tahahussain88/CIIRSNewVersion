<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainPage.aspx.cs" Inherits="CIIRSNewVersion.MainPage" %>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>Credit Initiation & Internal Risk Rating System</h1>
										...
										<form>
											<div class="form-row">
												<div class="form-group col-md-4">
													<input type="text" class="form-control my-2 my-lg-1" id="inputtext4" placeholder="CLP number">
												</div>
												<div class="form-group col-md-3">
													<select class="w-100 form-control mt-lg-1 mt-md-2">														
														<option value="1">Corporate</option>
														<option value="2">Commercial</option>
                                                        <option value="3">Medium Enterprise</option>
														<option value="4">Small Enterprise</option>
													</select>
												</div>
												<div class="form-group col-md-3">
													<input type="text" class="form-control my-2 my-lg-1" id="inputLocation4" placeholder="Client Number">
												</div>
...
<div class="product-item bg-light">
	<div class="card">
        ...
        <div class="package-content bg-light border text-center p-5 my-2 my-lg-0">
                    ...
                    <ul>                       
                        <li class="my-4"> <i class="fa fa-check"></i>Edit/Update eCLP</li>
                        <li class="my-4"> <i class="fa fa-check"></i>Carbon Copy</li>
                        <li class="my-4"> <i class="fa fa-check"></i>File Attachment</li>
                        <li class="my-4"> <i class="fa fa-check"></i>eIOM Submission</li>
                    </ul>
                    <a href="#" class="btn btn-primary">Create eCLP</a>
                </div>
		<%--<div class="card-body">
		    <h4 class="card-title"><a href="single.html">eCLP Module</a></h4>
...
<div class="product-item bg-light">
	<div class="card">
        ...
        <div class="package-content bg-light border text-center my-2 my-lg-0 p-5">
                    ...
                    <ul>                       
                        <li class="my-4"> <i class="fa fa-check"></i>Edit/Update eIOM</li>
                        <li class="my-4"> <i class="fa fa-check"></i>Carbon Copy</li>
                        <li class="my-4"> <i class="fa fa-check"></i>File Attachment</li>
                        <li class="my-4"> <i class="fa fa-check"></i>eIOM Submission</li>
                    </ul>
                    <a href="#" class="btn btn-primary">Create eIOM</a>
                </div>
		<%--<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
        ...
        <div class="package-content bg-light border text-center p-5 my-2 my-lg-0">
                    ...
                    <ul>
                        <li class="my-4"> <i class="fa fa-check"></i>Edit/Update ESMS</li>
                        <li class="my-4"> <i class="fa fa-check"></i>Carbon Copy</li>
                        <li class="my-4"> <i class="fa fa-check"></i>File Attachment</li>
                        <li class="my-4"> <i class="fa fa-check"></i>ESMS Submission</li>
                    </ul>
                    <a href="#" class="btn btn-primary">Create ESMS</a>
                </div>
		<%--<div class="card-body">
...
<div class="product-item bg-light">
	<div class="card">
        ...
        <div class="package-content bg-light border text-center p-5 my-2 my-lg-0">
                    <div class="package-content-heading border-bottom">
                            <i class="fa fa-rocket"></i>
                        <h2>Solar Energy Module</h2>
                        <%--<h4 class="py-3"> <span>$50.00</span> Per Month</h4>--%>
                    </div>
                    <ul>
                        <li class="my-4"> <i class="fa fa-check"></i>Edit/Update Module</li>
                        <li class="my-4"> <i class="fa fa-check"></i>Carbon Copy</li>
                        <li class="my-4"> <i class="fa fa-check"></i>File Attachment</li>
                        <li class="my-4"> <i class="fa fa-check"></i>Submission</li>
                    </ul>
